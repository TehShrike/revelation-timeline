...
var template$4 = function () {
	...
	return {
		oncreate: function oncreate() {
			...
			var componentListener = function componentListener() {
...
var template$3 = function () {
	return {
		...
		computed: {
			...
			nonIgnoredEvents: function nonIgnoredEvents(timeline, ignoreTypeMap) {
...
function encapsulateStyles(node) {
	setAttribute(node, 'svelte-3797330401', '');
}

function add_css() {
	var style = createElement$1('style');
	style.id = 'svelte-3797330401-style';
	style.textContent = "[svelte-3797330401].timeline-container,[svelte-3797330401] .timeline-container{display:flex;flex-wrap:nowrap;align-items:flex-start}[svelte-3797330401].timeline-column,[svelte-3797330401] .timeline-column{position:relative}[svelte-3797330401].axis,[svelte-3797330401] .axis{font-size:10px;width:100px;text-align:right}[svelte-3797330401].axis[data-relevant=true],[svelte-3797330401] .axis[data-relevant=true]{color:red}[svelte-3797330401].event-description-column,[svelte-3797330401] .event-description-column{display:flex;align-items:center;position:fixed;top:0;height:100%}";
	appendNode(style, document.head);
}
...
function create_main_fragment$1(state, component) {
	...
	var events_initial_data = {
		...
		clickable: true,
		ignoreType: state.currentZoom.ignoreType
	};
	...
	return {
		...
		hydrate: function hydrate(nodes) {
			...
			div_2.style.cssText = div_2_style_value = "width: " + template$1.helpers.multiplyIndentByWidth(state.indentLevels + 2) + "px";
		...
		update: function update(changed, state) {
			...
			if (div_2_style_value !== (div_2_style_value = "width: " + template$1.helpers.multiplyIndentByWidth(state.indentLevels + 2) + "px")) {
...
function Main(options) {
	...
	this._torndown = false;
	if (!document.getElementById('svelte-3797330401-style')) add_css();
